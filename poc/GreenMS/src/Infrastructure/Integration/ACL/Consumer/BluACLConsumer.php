...
namespace GreenMS\Infrastructure\Integration\ACL\Consumer;
...
class BluACLConsumer implements ConsumerInterface
{
    /** @var LoggerInterface */
    private $logger;
    ...
    public function execute(AMQPMessage $message)
    {
        ...
        try {
            ...
            echo sprintf('Green Anti Corruption Layer from Blu Bounded Contect - EVENT ID:%s @ %s ...', $body['event_id'], date('Y-m-d H:i:s')).PHP_EOL;
